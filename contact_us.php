...
<p class="p2">Alumni Management System</p>
<p class="p3">Lovely Professional University<br>
...
<tr>
	<td>
			...
			<p class="p3">Tel : 0182 440 4404</p>
			<p class="p3">Fax: +XXX XXX XXX </p>
			<p class="p3">Email Id: alumni@gmail.com </p>
	</td>
	<td >
    <p class="p2">Our Social Pages:</p>
  <p class="p3"> <a href="https://www.facebook.com/" target="_blank">
...
<p class="p3">All individuals who have sucessfully completed Diploma, Undergraduate, Postgraduate or PhD of
the programmes from Lovely Professional University can register as our alumni.</p>
<p class="p2"><br>How do I become a member of the Alumni Group?</p>
<p class="p3">It is important for alumni to update their particulars for the Alumni
  Directory (Database) by register as a member online so that we can keep in touch with you for lifetime.</p>
<p class="p2"><br>Do I need to pay any fee?</p>
<p class="p3">No, for alumni membership there is no charges. This is a platform to connect all the alumnis together. </p>
